...
\begin{figure}[htbp]
    \centering
    \includegraphics[max width=.75\textwidth, max height=0.85\textheight, keepaspectratio]{images/3-monitoring/RTA_architecture.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[max width=.8\textwidth, max height=0.85\textheight, keepaspectratio]{images/3-monitoring/coverage_gap.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[max width=.8\textwidth, max height=.85\textheight, keepaspectratio]{images/3-monitoring/monitors_voter.pdf}
