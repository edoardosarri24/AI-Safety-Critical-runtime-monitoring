...
\newcommand{\lezione}{
	{\fontsize{14pt}{\baselineskip}\selectfont Resiliency Real-Time and Certification}}
...
\begin{titlepage}
    ...
    \lezione \\
    \vspace{4cm}
    {\Huge\bfseries AI Safety Critical Runtime Monitoring} \\
    \vspace{2cm}
    {\Large\itshape Edoardo Sarri} \\
    \vspace{0.5cm}
    {\Large\itshape 7173337} \\
    \vfill
    {\fontsize{16pt}{\baselineskip}\selectfont Giugno 2026}
\end{titlepage}