...
When an AI-based system interacts with a human, the interaction can be done with different magnitudes. The EASA defines three levels of automation and assistance~\cite{agirre2025functional}:
\begin{enumerate}
    \item EASA Level 1 \\
